...
//  Spotify
//
//  Created by Vu Minh Tam on 8/4/21.
//
...
class LibraryAlbumsViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        noAlbumsView.frame = CGRect(x: (view.with - 150) / 2, y: (view.height - 150) / 2, width: 150, height: 150)
        tableView.frame = CGRect(x: 0, y: 0, width: view.with, height: view.height)
    }
