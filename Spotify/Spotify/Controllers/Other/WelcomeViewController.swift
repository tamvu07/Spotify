...
class WelcomeViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        signInButton.frame = CGRect(x: 20,
                                    ...
                                    width: view.with - 40,
                                    height: 50)
        logoImageView.frame = CGRect(x: (view.with - 120) / 2, y: (view.height - 350) / 2, width: 120, height: 120)
        label.frame = CGRect(x: 30, y: logoImageView.bottom + 30, width: view.with - 60, height: 150)
    }
