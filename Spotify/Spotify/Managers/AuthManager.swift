...
final class AuthManager {
    ...
    struct Constants {
        ...
        static let redirecURI = "https://www.iosacademy.io"
    ...
    public func exchangeCodeForToken (
        ...
        let basicToken = Constants.clientID+":"+Constants.clientSecrect
        ...
        let tast = URLSession.shared.dataTask(with: request) { [weak self] data, _, error in
            guard let data = data,
                  error == nil else {
                completion(false)
                return
