...
class NewReleaseCollectionViewCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        let albumLabelSize = albumNameLabel.sizeThatFits(CGSize(width: contentView.with - imageSize - 10,
        ...
        artistNameLabel.frame = CGRect(x: albumCoverImageView.right + 10,
                                       ...
                                       width: contentView.with - albumCoverImageView.right - 10,
                                           height: 30)
        
        numberOfTracksLabel.frame = CGRect(x: albumCoverImageView.right + 10,
                                           y: contentView.bottom - 44,
                                           width: numberOfTracksLabel.with,
                                           height: 44)
    }
